...
class MongoModel
{
    ...
    {
        $this->db = (new Mongo('mongodb+srv://'.env('MONGODB_USERNAME').':'.env('MONGODB_PASSWORD').'@cluster0.zkwdz.mongodb.net/'.self::DATABASE.'?retryWrites=true&w=majority'))->{self::DATABASE};
